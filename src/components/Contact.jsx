       ...
       <div className='relative rounded-lg bg-black py-24 text-blue-50 sm:overflow-hidden'>
         <div className='absolute -left-20 top-0 hidden h-full w-72
           overflow-hidden sm:block lg:left-20 lg:w-96'>
                ...
                <ImageClipBox src='img/contact-2.webp' clipClass="contact-clip-path-2 lg:translate-y-40
                    translate-y-60" />
           </div>
           ...
           <div className='flex flex-col items-center text-center'>
             <p className='font-general text-[10px] uppercase'>Join Valo</p>
             <p className='special-font mt-10 w-full font-zentry text-5xl leading-[0.9]'>Let's b<b>u</b>ils the<br /> new era of g<b>a</b>ming t<b>o</b>gether </p>
