  ...
  return (
    <div className='relative h-dvh w-screen overflow-x-hidden'>
      ...
      <div id="video-frame" className="relative z-10 h-dvh w-screen
               ...
               absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg'>
                 <div onClick={handleMiniVdClick} 
                    ...
                    <video ref={nextVideoRef}
                           ...
                           muted
                           id='current-video'
                           className='size-64 cursor-pointer origin-center scale-150
          ...
          <div className='absolute left-0 top-0 z-40 size-full'>
             <div className='mt-24  px-5 sm:10'>
                <h1 className='special-font hero-heading'><span className='text-red-600'>r<b>e</b>d</span>efi<b>n</b>e</h1>
                <p className='mb-5 max-w-64 font-robert-regular
                  text-blue-100'>Enter the MetaGame Layer <br/> <b>Unleash</b> the Play 
                   Economy  
                </p>
      ...
      <h1 className='special-font hero-heading absolute bottom-5 text-black'>
            G<b>a</b><span className='text-yellow-600'>mi</span>ng
          </h1>
    </div>
  )
}
